							...
							<div class="col-lg-12 col-md-12  col-builder">
								<div class="row content-panel empty-block">
									<div class="add-new-block col-md-12">
										<a href="'.$this->_urlBuilder->getUrl('mpanel/create/block', ['name'=>$name.'-0']).'" title=" '.__('Add New Block').'" class="btn btn-primary popup-link btn-new-block">
											<em class="fa fa-plus"></em> '.__('Add New Block').'			
										</a>
									</div>
								</div>
							</div>
