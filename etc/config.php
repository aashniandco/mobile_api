...
return [
    'modules' => [
        ...
        'Ebs_Payment' => 1,
        'Eleadtech_Bcore' => 1,
        'Eleadtech_AlphabetOption' => 1,
        'Facebook_BusinessExtension' => 0,
        'Faonni_IndexerUrlRewrite' => 1,
        'Fermion_JCVersioning' => 1,
        'Fermion_LoyaltyPoint' => 1,
        'Fermion_NativeApp' => 1,
        'Fermion_Pagelayout' => 1,
        ...
        'Mageprince_BuyNow' => 1,
        'Mec_Cartblock' => 1,
        'Mec_CategoryDesignerInfo' => 1,
        'Mec_CheckoutLogin' => 1,
        'Mec_ConfigurableProduct' => 1,
        'Mec_CountryAutoSelect' => 1,
        'Mec_CustomLogs' => 1,
        'Mec_Customtab' => 1,
        'Mec_Designerpage' => 1,
        'Mec_Enquire' => 1,
        'Mec_Gridimage' => 1,
        'Mec_MassProcessingOrder' => 1,
        'Mec_PriceModifier' => 0,
        'Mec_ProductTag' => 1,
        'Mec_PurchaseOrder' => 1,
        'Mec_RestrictPaymentMethod' => 1,
        'Mec_SessionConfig' => 0,
        'Mec_Shipitem' => 1,
        'Mec_ShippingRule' => 1,
        'Mec_SuggestedProducts' => 1,
        'Mirasvit_Core' => 1,
        ...
        'PHPCuong_Newsletter' => 1,
        'PayUIndia_Payu' => 1,
        'SR_MagentoCommunity' => 0,
        'Sam_CaptureAdminOrder' => 1,
